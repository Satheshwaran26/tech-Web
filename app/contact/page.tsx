...
const Contact = () => {
  ...
  return (
    <div className="bg-[#080808] flex flex-col md:flex-row items-center justify-center px-6 py-24 text-[#d0d0d0] max-w-[1600px] mx-auto">
      ...
      <div className="relative md:w-1/2 p-6 bg-[#080808] max-w-xl border-2 border-[#212020] rounded-lg shadow-xl overflow-hidden">
  <h2 className="text-2xl font-extralight mb-4">Fill the form below</h2>

  <form onSubmit={handleSubmit} className="relative">
    {/* Blurred Circle Effect Inside the Form */}
    <div className="absolute top-2 right-2 w-20 h-20 bg-gray-500 opacity-30 blur-3xl rounded-full"></div>
